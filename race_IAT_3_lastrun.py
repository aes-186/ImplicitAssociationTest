...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/Anzu/race_IAT_3/race_IAT_3_lastrun.py',
...
exemplars_filename = 'stimuli_3.xlsx'
...
# for debugging
# print("rows of the stimuli file exemplars: ")
# print(n_exemplars) 
...
def generate_trials(trial_type_column, multiplier):
    ...
    # if text_trial_type_3_exemplars or text_trial_type_4_exemplars 
    print("curr trial_type_column: ")
    print(trial_type_column)
    
    if (trial_type_column=='text_trial_type_3_exemplars' or trial_type_column=='text_trial_type_4_exemplars'):
        for i in range(8): 
            a[i] = [exemplars[i][trial_type_column]]*multiplier  # populate the dict from vertical reads of the conditions
    else:
        # if any other trial_type_column
        for i in range(6):
        # i should be either 6 or 8 depending on trial_type_column
            a[i] = [exemplars[i][trial_type_column]]*multiplier  # populate the dict from vertical reads of the conditions
    ...
    return a
    # a is a list populated by trial type stim names 
...
blocks = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('instructions_3.xlsx'),
...
for thisBlock in blocks:
    ...
    if blocks.thisN == 0:
        ...
        print("modified list multiplier for block 0")
        print(modified_list_multiplier)
        ...
        print("modified list multiplier for block 1")
        print(modified_list_multiplier)
        ...
        print("modified list multiplier for block 2")
        print(modified_list_multiplier)
        ...
        print("modified list multiplier for block 3")
        print(modified_list_multiplier)
        
    elif blocks.thisN == 4:
        
        # want 14 of each = 28 trials here
        
        trial_rows = "0:2" 
        n_block_repeats = 14   #2*20 = 40 trials
        modified_list_multiplier = list_multiplier * 2  # because this block has a different trials:categories ratio
        
        print("modified list multiplier for block 4")
        print(modified_list_multiplier)
        ...
        print("modified list multiplier for block 5")
        print(modified_list_multiplier)
        ...
        print("modified list multiplier for block 6")
        print(modified_list_multiplier)
    ...
    print("text trial type 1 trials: ")
    print( *text_trial_type_1_trials )
    print("length of text_trial_type_1_trials: ")
    print( len(text_trial_type_1_trials) ) 
    
    text_trial_type_2_trials = generate_trials('text_trial_type_2_exemplars', modified_list_multiplier)
    
    print("text trial type 2 trials: ")
    print( *text_trial_type_2_trials )
    print( len(text_trial_type_2_trials))
    
    text_trial_type_3_trials = generate_trials('text_trial_type_3_exemplars', modified_list_multiplier)
    
    print("text trial type 3 trials: ")
    print( *text_trial_type_3_trials )
    print( len(text_trial_type_3_trials))
    
    text_trial_type_4_trials = generate_trials('text_trial_type_4_exemplars', modified_list_multiplier)
    
    print("text trial type 4 trials: ")
    print( *text_trial_type_4_trials )
    print( len(text_trial_type_4_trials))
    
    
    img_trial_type_1_trials = generate_trials('img_trial_type_1_exemplars', modified_list_multiplier)
    
    print("image trial type 1 trials: ")
    print(*img_trial_type_1_trials)
    print("len of img_trial_type_1_trials: ")
    print(len(img_trial_type_1_trials))
    
    img_trial_type_2_trials = generate_trials('img_trial_type_2_exemplars', modified_list_multiplier)
    
    
    print("image trial type 2 trials: ")
    print(*img_trial_type_2_trials)
    print("len of img_trial_type_2_trials: ")
    print(len(img_trial_type_2_trials))
    
    img_trial_type_3_trials = generate_trials('img_trial_type_3_exemplars', modified_list_multiplier)
    
    
    print("image trial type 3 trials: ")
    print(*img_trial_type_3_trials)
    print("len of img_trial_type_3_trials: ")
    print(len(img_trial_type_3_trials))
    
    img_trial_type_4_trials = generate_trials('img_trial_type_4_exemplars', modified_list_multiplier)
    
    
    print("image trial type 4 trials: ")
    print(*img_trial_type_4_trials)
    print("len of img_trial_type_4_trials: ")
    print(len(img_trial_type_4_trials))
    
    # set category and attribute labels based on the block order and current block
    if block_order == 1 and blocks.thisN <= 3:
        
        print("block_order 1, curr block <=3")
        
        leftCategory = categoryA
        rightCategory = categoryB
        print("left cat: " + leftCategory)
        print("right cat: " + rightCategory)
        
    elif block_order == 1 and blocks.thisN > 3:
        leftCategory = categoryB
        rightCategory = categoryA
        
        print("block order 1, curr block > 3")
        print("left cat: " + leftCategory)
        print("right cat: " + rightCategory)
    ...
    trials = data.TrialHandler(nReps=n_block_repeats, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('block_layout_3.xlsx', selection=trial_rows),
    ...
    for thisTrial in trials:
        ...
        if trial_type == 1:
            ...
            print("trial type 1, text stim: " + text_stimulus)    
            image_stimulus = img_trial_type_1_trials.pop()
            print("trial type 1, image stim: " + image_stimulus)
            w_count = w_count+1
            
        elif trial_type == 2:
            text_stimulus = text_trial_type_2_trials.pop()
            print("trial type 2, text_stim: " + text_stimulus)
            image_stimulus = img_trial_type_2_trials.pop()
            print("trial type 2, img stim: " + image_stimulus)
            b_count = b_count+1
            ...
            print("trial type 3, text_stim: " + text_stimulus)
        
            image_stimulus = img_trial_type_3_trials.pop()
            print("trial type 3, img stim: " + image_stimulus)
        
        elif trial_type == 4:
            text_stimulus = text_trial_type_4_trials.pop()
            
            print("trial type 4, text stim: " + text_stimulus)
            neg_count = neg_count+1
        
            image_stimulus = img_trial_type_4_trials.pop()
            print("trial type 4, img stim: " + image_stimulus)
        ...
        count = count+1
        # for debugging
        print("CURRENT BLOCK: " + str(blocks.thisN) + " CURRENT TRIAL COUNT: " + str(count) + " b: " + str(b_count) + " w: " + str(w_count) + " p: " + str(pos_count) + " n: " + str(neg_count))
